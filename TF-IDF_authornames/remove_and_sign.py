from multiple_pdfs_to_list import multiple_pdfs_to_list

def remove_and_sign(speicherpfad, file_name_list):
    ...
    """
    list_of_texts=multiple_pdfs_to_list(speicherpfad, file_name_list)
    for papers in list_of_texts:
        papers=papers.replace('&', '')
    return list_of_texts

if __name__ =="__main__":
    print(remove_and_sign('/Users/giangraf/code/GianGraf/le_wagon_final_project/data/data', ['asset_prcing_1.pdf','asset_prcing_2.pdf', 'asset_prcing_3.pdf']))
